# Índice de skills — Aula 03

## Squad principal

| Ordem | Skill | Entrada principal | Saída esperada |
|---:|---|---|---|
| 1 | `/zelador` | evidências de tracking e operação | `trafficTrackingAudit` |
| 2 | `/briefista` | ângulos validados e contexto do projeto | bateria de anúncios e curadoria pendente |
| 3 | `/estruturador` | oferta, briefing e criativos aprovados | plano recommend-only de campanha |
